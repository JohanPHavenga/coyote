    ...
    <div class="container">
        <div class="row">
            ...
            <div class="content col-lg-9">
                <!-- <h3 class="text-uppercase">RoadRunningZA Disclaimer</h3> -->
                ...
                <ul>
                    ...
                    <li>
                        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to RoadRunningZA.</p>
                    </li>
                    <li>
                    ...
                    <li>
                        <p><strong>Website</strong> refers to RoadRunningZA, accessible from <a href="https://www.roadrunning.co.za/" rel="external nofollow noopener" target="_blank">https://www.roadrunning.co.za/</a></p>
                    </li>
                    <li>
                ...
                <ul>
                    <li>
                        <?php
                        $attributes = array('title' => 'Privacy Policy Query');
                        ?>
                        <p>By email: <?php echo safe_mailto('info@roadrunning.co.za', 'info@roadrunning.co.za', $attributes); ?></p>
                    </li>
                    <li>
                        <p>By visiting this page on our website: <a href="https://www.roadrunning.co.za/contact" rel="external nofollow noopener" target="_blank">https://www.roadrunning.co.za/contact</a></p>
                    </li>
                </ul>
            </div>
            <!-- end: Content-->
