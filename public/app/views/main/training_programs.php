    ...
    <div class="container">
        <div class="row">
            ...
            <div class="content col-lg-9">
                ...
                <p>Looking for a <b>training program</b> to train for your <b>first 5km?</b>.
                    Maybe you want to run a <b>sub 4-hour marathon</b>? Or in need of a masterplan
                    to run through menopause?<br>
                ...
                <p>Alternatively click below to check out their offerings and find the best fit for you:</p>
                <p><a href="https://coachparry.com/training-programmes#run?via=roadrunningza" class="btn btn-default"><i class="fa fa-running"></i> Running Training Plans</a>
                <p>
            </div>
            <!-- end: Content-->
